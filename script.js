...
class Staff extends HTMLElement {
    ...
    b,i,u::before,u::after,span {position:absolute;}
...
class Note extends Staff {
    ...
    static coor = {
        ...
        C4:21, 'C#4':11, D4:22, 'D#4':[12,42], E4:32, F4:32, 'F#4':42, G4:22, 'G#4':[13,12], A4:23, 'A#4':43, B4:32,
        C5:32, 'C#5':43, D5:23, 'D#5':[14,13], E5:24, F5:34, 'F#5':44, G5:34, 'G#5':[44,14], A5:24, 'A#5':15, B5:25,
